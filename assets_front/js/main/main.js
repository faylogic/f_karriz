...
$(document).ready(function() {
    ...
    $(function() {
        ...
        var owlSectionThreeItembanner = $(".owlSectionThreeItembanner");
        owlSectionThreeItembanner.owlCarousel({
            autoPlay: 5000,
            items : 3,  
            itemsDesktop : [1000,3],  
            itemsDesktopSmall : [900,3],  
        ...
        var xowlSectionThreeItem2 = $(".owlSectionThreeItem2");
        xowlSectionThreeItem2.owlCarousel({
            autoPlay: 5000,
            items : 3,  
            itemsDesktop : [1000,3],  
            itemsDesktopSmall : [900,3],  
        ...
        var owlSectionThreeItem3 = $("#owlSectionThreeItem3");
        owlSectionThreeItem3.owlCarousel({
            autoPlay: 5000,
            items : 3,  
            itemsDesktop : [1000,3],  
            itemsDesktopSmall : [900,3],  
