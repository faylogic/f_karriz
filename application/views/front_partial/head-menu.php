<nav class="navbar navbar-pasific navbar-mp megamenu navbar-fixed-top <?php echo $menu ?>">
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-main-collapse">
                <i class="fa fa-bars"></i>
            </button>
            <a class="navbar-brand navbar-brand-img page-scroll" href="<?php echo base_url() ?>">
                <img src="<?php echo base_url() ?>file/logo/logo-default-img.png" alt="logo">
            </a>
        </div>
