            ...
            <div class="container">
                <div class="row mt20 mb30">
                    <div class="col-md-6 text-left">
                        <h3 class="color-light text-uppercase animated" data-animation="fadeInUp" data-animation-delay="100"><small class="color-light alpha7"><?php echo $title_bar ?></small></h3>
                    </div>                   
                </div>
            </div>
